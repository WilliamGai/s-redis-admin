...
<template>
	<section>
		...
		<el-table :data="users" highlight-current-row @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="userName" label="userName" width="100" sortable>
			</el-table-column>
			<el-table-column prop="email" label="Email" width="200" sortable>
			</el-table-column>
			<el-table-column prop="mobile" label="Mobile" width="100" sortable>
			</el-table-column>
    ...
    -->
      ...
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="排序权重">
					<el-input-number v-model="editForm.order_num" :min="-10000" :max="10000"></el-input-number>
				</el-form-item>
				<!-- <el-form-item label="日期">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.someDate"></el-date-picker>
				</el-form-item> -->
